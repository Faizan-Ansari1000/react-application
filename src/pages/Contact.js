...
function Contact() {
    ...
    const sendData = () => {
        console.log(model)
        axios.post('https://fakestoreapi.com/products', model)
            .then((res) => {
    ...
    return (
        <div>
            ...
            <div>
                <div className="m-3">
                    <button onClick={goToHome} className="bg-orange-500 text-white px-8 py-3 rounded-lg transition duration-300 transform hover:scale-105 mr-4 hover:text-orange-500 hover:bg-white
                    ">
                       Back To Home
                    </button>
                </div>
            ...
            <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg m-5">
                <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                    ...
                    <div class="bg-gray-100 p-6 rounded-lg">
                        ...
                        <div class="space-y-4 max-lg:mt-4">
                            <button type="button" class="px-4 py-2 rounded-lg bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">App development</button>
                            ...
                            <button type="button" class="px-4 py-2 rounded-lg bg-transparent text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300">AI system</button>
                        </div>

                        <div class="mt-8 space-y-4">
                            <input onChange={(e) => setModel({ ...model, firstName: e.target.value })} placeholder='Name'
                            ...
                            <input onChange={(e) => setModel({ ...model, email: e.target.value })} placeholder='Email'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
                            <input onChange={(e) => setModel({ ...model, subject: e.target.value })} placeholder='Subject'
                                class="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
                            <textarea onChange={(e) => setModel({ ...model, message: e.target.value })} placeholder='Message' rows="6"
                ...
                <div>
                    {list.map((x, i) => (
                        <div className="flex flex-wrap justify self-center" key={i}>
                            <p><b>Name:</b> {x.firstName}</p>
                            <p><b>Email:</b> {x.email}</p>
                            <p><b>Subject:</b> {x.subject}</p>
